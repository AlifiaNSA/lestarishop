  ...
  const loadOrderData = async () => {
    try {
      ...
      if (response.data.success) {
        // Keep orders as is, but add order-level properties to each item if needed
        // Here we keep the structure: array of orders, each with items array
    ...
    <div>
      <div className="bg-primary mb-16">
        <div className="max-padd-container py-10">
          ...
          {orders.map((order, i) => (
            <div key={i} className="bg-white p-4 mt-3 rounded-lg">
