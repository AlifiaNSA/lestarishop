      ...
      <div className="max-padd-container">
        ...
        <div className="flex gap-12 flex-col xl:flex-row bg-primary rounded-2xl p-3 mb-6">
          ...
          <div className="flex-[1.5] rounded-2xl xl:px-7">
            <h3 className="h3 loading-none">{product.name}</h3>
            {/* Rating and price */}
            ...
            <div className="flex flex-col gap-4 my-4 mb-5">
              <div className="flex gap-2">
                {[...product.sizes]
                  ...
                  .map((item, i) => (
                    <button key={i} onClick={() => setSize(item)} className={`${item === size ? "ring-1 ring-slate-900/20" : "ring-1 ring-slate-900/5"} 
            ...
            <div className="flex items-center gap-x-2 mt-3">
              ...
              <span className="medium-14">
                Pengiriman Gratis untuk pesanan lebih dari Rp100.000
              </span>
            </div>
            <hr className="my-3 w-2/3" />
            <div className="mt-2 flex flex-col gap-1 text-gray-30 text-[14px]">
              <p>Keaslian yang Dapat Anda Percayai</p>
              <p>Nikmati Layanan Bayar di Tempat untuk Kenyamanan Anda</p>
              <p>Pengembalian dan Penukaran Mudah dalam 7 hari</p>
            </div>
          </div>
        </div>
        <div>
